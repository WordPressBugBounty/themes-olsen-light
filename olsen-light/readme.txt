...
= 1.7.1 =
* Future-proof support for One Click Demo Import, by replacing older 'pt-ocdi/*' hook names with the more recent 'ocdi/' ones.
* Fix an issue where the image selection preview would throw JS errors if a non-image file was selected on the About me widget.
